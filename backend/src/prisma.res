...
@send external findUnique: (model<'t>, uniqueWhere) => promise<Js.nullable<'m>> = "findUnique"
@send
external findUniqueSelect: (model<'t>, uniqueWhereSelect<'m>) => promise<Js.nullable<'n>> = "findUnique"
